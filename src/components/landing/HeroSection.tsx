  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center max-w-5xl">
        ...
        <motion.h1
          className="font-display font-black text-4xl md:text-6xl lg:text-7xl text-heading leading-tight mb-6"
        ...
        <motion.p
          className="text-lg md:text-xl text-body max-w-2xl mx-auto mb-10 font-body"
        ...
        >
          <a href="#planos" className="inline-flex items-center justify-center px-8 py-4 rounded-lg font-display font-bold text-lg bg-primary text-primary-foreground hover:brightness-110 transition-all shadow-premium">
            Quero Meu Site de Alto Padrão
          </a>
          <a href="#modelos" className="inline-flex items-center justify-center px-8 py-4 rounded-lg font-display font-semibold text-lg border-2 border-primary/30 text-heading hover:bg-primary/10 transition-all">
